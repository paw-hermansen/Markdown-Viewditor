...
- [x] **Ask before closing**: When closing the app and changes exists then the user should be asked if they want to save the file before leaving the app.
...
- [X] **Icon**: Create and add an icon for the app.
